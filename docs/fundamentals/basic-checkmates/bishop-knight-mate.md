...
description: Checkmate technique for bishop and knight versus lone king — the hardest of the basic checkmates
---
...
The bishop, on c1, controls the c1-h6 diagonal, preventing escape.
