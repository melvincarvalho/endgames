...
sidebar_position: 0
title: Home
description: Comprehensive chess endgame documentation
---
...
<div className="hero-banner">
  ...
  <div className="hero-content">
    ...
    <h1 className="hero-title">Chess Endgames</h1>
    <p className="hero-subtitle">
      Master the art of converting advantages and saving lost positions. Your comprehensive guide to endgame excellence.
    </p>
...
<div className="cards-grid">
  <a href="./pawn-endgames/principles" className="feature-card">
    ...
    <p className="card-description">
      The foundation of endgame play. Master opposition, key squares, and pawn breakthroughs.
    </p>
  ...
  <a href="./rook-endgames/principles" className="feature-card">
    ...
    <p className="card-description">
      The most common endgame type. Learn Lucena, Philidor, and essential rook activity principles.
    </p>
    <span className="card-arrow">&#8594;</span>
  </a>
  <a href="./minor-piece-endgames/overview" className="feature-card">
    ...
    <p className="card-description">
      Bishop and knight endgames. Understand good vs bad bishops and knight maneuvering.
    </p>
    <span className="card-arrow">&#8594;</span>
  </a>
  <a href="./queen-endgames/overview" className="feature-card">
    ...
    <p className="card-description">
      Complex tactical battles with perpetual check threats and precise calculation required.
    </p>
    <span className="card-arrow">&#8594;</span>
  </a>
</div>
...
<div className="positions-grid">
  <a href="./fundamentals/basic-checkmates/queen-mate" className="position-card">
    ...
    <div className="position-info">
      ...
      <span className="position-type">
        <span className="level-dot level-beginner"></span>
        Checkmate
      </span>
    </div>
  </a>
  ...
  <a href="./rook-endgames/lucena-position" className="position-card">
    ...
    <div className="position-info">
      ...
      <span className="position-type">
        <span className="level-dot level-intermediate"></span>
        Rook Endgame
      </span>
    </div>
  </a>
...
<div className="themes-list">
  ...
  <a href="./strategic-themes/fortresses" className="theme-item">
    ...
    <div className="theme-content">
      <h4>Fortresses</h4>
      <p>Unbreakable defensive setups</p>
    </div>
  </a>
</div>
...
<div className="info-box">
  ...
  <p>This documentation is designed to grow over time, providing everything you need to master chess endgames.</p>
